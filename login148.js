class Login {
  ...
  static verificaLogin = () => {
    ...
    const endpoint = `https://4b2488c0-2084-4139-8e1e-a8f741b3cabf-00-h6125op4gwcr.worf.replit.dev/?matricula=${mat}&senha=${pas}`;
    fetch(endpoint)
      .then((res) => res.json())
      .then((res) => {
        if (res) {
          ...
          alert("Login não efeturado! Username ou senha incorretos");
        }
      });
